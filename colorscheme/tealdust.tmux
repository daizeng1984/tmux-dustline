#!/usr/bin/env bash
# Teal Dust color scheme - dusty teal
# Main: colour37 (#00afaf), all variations lighter

# The copy modes etc
tmux setw -g mode-attr bold
tmux setw -g mode-fg colour80
...
tmux set -g pane-active-border-fg colour80
tmux set -g pane-active-border-bg colour37

# The statusbar
tmux set -g status-bg colour235
tmux set -g status-fg colour37
...
'#{dustline_scheme_end}'
tmux setw -g window-status-fg colour80
tmux setw -g window-status-bg colour235
tmux setw -g window-status-current-fg colour116
...
tmux set -g message-bg colour80
...
myscheme_prefixon_mainscreen_background='colour123'
# Overall status bar color with prefix on/off
myscheme_prefixon_fg='colour232'
myscheme_prefixon_bg='colour116'
myscheme_prefixoff_fg='colour37'
...
myscheme_boundary_bg='colour80'
myscheme_boundary_prefix_fg='colour232'
myscheme_boundary_prefix_bg='colour116'
