#!/usr/bin/env bash
# Purple Dust color scheme - lavender purple
# Main: colour104 (#8787d7), all variations lighter

# The copy modes etc
tmux setw -g mode-attr bold
tmux setw -g mode-fg colour141
...
tmux set -g pane-active-border-fg colour141
tmux set -g pane-active-border-bg colour104

# The statusbar
tmux set -g status-bg colour235
tmux set -g status-fg colour104
...
'#{dustline_scheme_end}'
tmux setw -g window-status-fg colour141
tmux setw -g window-status-bg colour235
tmux setw -g window-status-current-fg colour147
...
tmux set -g message-bg colour141
...
myscheme_prefixon_mainscreen_background='colour183'
# Overall status bar color with prefix on/off
myscheme_prefixon_fg='colour232'
myscheme_prefixon_bg='colour147'
myscheme_prefixoff_fg='colour104'
...
myscheme_boundary_bg='colour141'
myscheme_boundary_prefix_fg='colour232'
myscheme_boundary_prefix_bg='colour183'
...
myscheme_tab_fg='colour141'
myscheme_tab_bg='colour235'
myscheme_tab_prefixon_fg='colour232'
myscheme_tab_prefixon_bg='colour147'

myscheme_current_tab_fg='colour232'
myscheme_current_tab_bg='colour104'
myscheme_current_tab_prefixon_fg='colour232'
myscheme_current_tab_prefixon_bg='colour183'
