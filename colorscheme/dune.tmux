...
myscheme_current_tab_fg='colour255'
myscheme_current_tab_bg='colour137'
myscheme_current_tab_prefixon_fg='colour58'
myscheme_current_tab_prefixon_bg='colour222'

tmux setw -g window-status-current-format '#{dustline_scheme_begin}'\
'#[bold]#I:#[fg=colour58]#W#[fg=colour0,bold]#F'\
'#{dustline_scheme_end}'
tmux setw -g window-status-format '#{dustline_scheme_begin}'\
'#I#[fg=colour237]:#[fg=colour255]#W#[fg=colour244]#F'\
'#{dustline_scheme_end}'
