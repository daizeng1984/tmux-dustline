#!/usr/bin/env bash
# Mario color scheme - red hat, blue overalls, gold coins, green pipes
# A good resource to lookup terminal color
# https://upload.wikimedia.org/wikipedia/commons/1/15/Xterm_256color_chart.svg

# The copy modes etc
tmux setw -g mode-attr bold
tmux setw -g mode-fg colour226
...
tmux set -g pane-active-border-fg colour196
tmux set -g pane-active-border-bg colour124

# The statusbar
tmux set -g status-bg colour235
tmux set -g status-fg colour226
...
'#{dustline_scheme_end}'
tmux setw -g window-status-fg colour226
...
tmux set -g message-bg colour196
...
myscheme_prefixon_fg='colour226'
myscheme_prefixon_bg='colour34'
myscheme_prefixoff_fg='colour226'
...
myscheme_boundary_bg='colour220'
myscheme_boundary_prefix_fg='colour232'
myscheme_boundary_prefix_bg='colour34'
...
myscheme_tab_fg='colour226'
myscheme_tab_bg='colour235'
myscheme_tab_prefixon_fg='colour226'
myscheme_tab_prefixon_bg='colour22'

myscheme_current_tab_fg='colour232'
myscheme_current_tab_bg='colour196'
myscheme_current_tab_prefixon_fg='colour232'
myscheme_current_tab_prefixon_bg='colour34'
